...
```
./deploy/kafka/bin/kafka-console-consumer.sh --zookeeper localhost:2181 --topic dummyTopic
```
...
```
./deploy/kafka/bin/kafka-console-consumer.sh --zookeeper localhost:2182 --topic dummyTopic1
```
...
```
./deploy/kafka/bin/kafka-topics.sh --create --zookeeper localhost:2182 --topic dummyTopic --partition 1 --replication-factor 1
```
...
```
./deploy/kafka/bin/kafka-console-consumer.sh --zookeeper localhost:2182 --topic dummyTopic
```
